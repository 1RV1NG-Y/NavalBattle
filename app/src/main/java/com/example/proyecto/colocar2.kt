...
var todo2 = ArrayList<Int>()
class colocar2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_colocar2)
    ...
    fun buttonClick(view: View) {
        ...
        if (lanchab) {
            ...
            if (horizontal.isChecked) {
                ...
                todo2 = (porta + buque + submarino + crucero + lancha) as ArrayList<Int>
